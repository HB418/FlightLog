$files = 'db.js','stock-courses.js','ratings.js','map-icons.js','course-wizard.js','admin-panel.js','round.js','putt-practice.js','discs.js','og-mode.js','main.js','namePrompt.js'
$all = @()
foreach ($f in $files) {
